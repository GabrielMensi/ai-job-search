...
**English:**
```
"[YOUR_PRIMARY_JOB_TITLE_1]" [YOUR_KEY_SKILL] remote
...
**Spanish:**
```
"[YOUR_PRIMARY_JOB_TITLE_1_ES]" [YOUR_KEY_SKILL] remoto
"[YOUR_PRIMARY_JOB_TITLE_2_ES]" [YOUR_KEY_SKILL] remoto
site:linkedin.com/jobs "[YOUR_PRIMARY_JOB_TITLE_1_ES]" remoto
