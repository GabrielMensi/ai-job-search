...
`language_gate`/`language_note` come from `04-job-evaluation.md`'s Deal-Breaker Gate language sub-check — distinct from `language` above, which just records what language the posting is written in.
