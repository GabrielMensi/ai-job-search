...
- **Match the language of the job posting** (e.g. a Spanish posting gets a Spanish cover letter, an English posting gets an English cover letter — whatever language the posting is actually written in)
